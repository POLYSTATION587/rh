...
if(@$vendedores == 'ocultar'){
 ...
 <button onclick="inserir()" type="button" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Proprietário</button>
				...
				<div class="modal-body">			
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
						<div class="col-md-6">							
							...
							<span id="profissao_mostrar"></span>							
						</div>
