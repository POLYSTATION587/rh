					...
					<div class="tab-content" id="myTabContent">
						...
						<div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="col-md-3">						
									<div class="form-group"> 
										...
										<select class="form-control sel2" name="status" id="status" required style="width:100%;"> 
											...
											<option value="Para Aluguél">Para Aluguel</option>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group"> 
										...
										<input type="number" class="form-control" name="ano" id="ano" placeholder="Ex: 1990"> 
									</div>
								</div>	
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group"> 
										...
										<input type="text" class="form-control" name="complemento" id="complemento" placeholder="Edifício X, Sala X ..." > 
									</div>
								</div>	
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group"> 
										...
										<select class="form-control " name="financiamento" id="financiamento" required style="width:100%;"> 
								...
								<div class="col-md-3">
									<div class="form-group"> 
										...
										<input type="text" class="form-control" name="condicao_pgto" id="condicao_pgto" placeholder="Financiado, à Vista, troca.." > 
									</div>
								</div>

								<div class="col-md-2">
									<div class="form-group"> 
										<label>Comissão IMOB</label> 
								...
								<div class="col-md-3">
									<div class="form-group"> 
										...
										<input type="text" class="form-control" name="chave" id="chave" placeholder="Responsável ou Lugar" > 
									</div>
								</div>	
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group"> 
										<label>Número Vaga</label> 
										<input type="text" class="form-control" name="numero_vaga" id="numero_vaga" placeholder="Número da vaga ou vagas" > 
									</div>
								</div>	
			...
			<div class="row" style="border-bottom: 1px solid #cac7c7;">
				...
				<div class="row" style="border-bottom: 1px solid #cac7c7;">
					...
					<div class="col-md-8">							
						...
						<span id="complemento_mostrar"></span>							
					</div>
					<div class="col-md-4">							
						<span><b>Número Vaga: </b></span>
						<span id="numero_vaga_mostrar"></span>
					</div>
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
					<div class="col-md-4">							
						<span><b>Financiamento: </b></span>
						<span id="financiamento_mostrar"></span>							
					</div>
					<div class="col-md-4">							
						<span><b>Local Chave: </b></span>
						<span id="chave_mostrar"></span>
					</div>

					<div class="col-md-4">							
						<span><b>Condição PGTO: </b></span>
						<span id="condicao_pgto_mostrar"></span>							
					</div>
