...
$id = $_POST['id'];
$numero_vaga = $_POST['numero_vaga'];
$financiamento = $_POST['financiamento'];
$chave = $_POST['chave'];
$condicao_pgto = $_POST['condicao_pgto'];
...
$query->bindValue(":condicao_pgto", "$condicao_pgto");
$query->bindValue(":chave", "$chave");
$query->bindValue(":complemento", "$complemento");
$query->bindValue(":numero_vaga", "$numero_vaga");
$query->execute();
