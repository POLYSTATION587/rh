...
$query = $pdo->query("SELECT * FROM agentepublico WHERE ativo = 'Sim'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_agentes = @count($res);

$query = $pdo->query("SELECT * FROM agentepublico WHERE federal = 'Sim'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_federais = @count($res);


$query = $pdo->query("SELECT * FROM agentepublico WHERE efetivo = 'Sim' and comissionado = 'Não'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_efetivos = @count($res);

$query = $pdo->query("SELECT * FROM agentepublico WHERE efetivo = 'Sim' and comissionado = 'Sim'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_efetivo_comissionado = @count($res);

$query = $pdo->query("SELECT * FROM agentepublico WHERE comissionado = 'Sim' and efetivo = 'Não'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_comissionados = @count($res);
...
<div class="main-page">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $total_agentes ?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $total_federais ?></strong></h5>
                      <span>Agente Federal</span>
                    </div>
                </div>
        	</div>
        	</a>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $total_efetivos ?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $total_comissionados ?></strong></h5>
                      <span>Agente Comissionado</span>
                    </div>
                </div>
        	 </div>
        	 </a>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $total_efetivo_comissionado ?></strong></h5>
                      <span>Efetivo e Comissionado</span>
                    </div>
                </div>
        	 </div>
        	</a>
