			...
			<aside class="sidebar-left">
				<nav class="navbar navbar-inverse" style="overflow: scroll; height:100%; scrollbar-width: thin;">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="./"><span class="fa fa-area-chart"></span>SETRABES<span class="dashboard_text">Relações Humanas</span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$cargos ?>"><a href="index.php?pagina=cargos_federal"><i class="fa fa-angle-right"></i> Cargo Federal</a></li>
									<li class="<?php echo @$cargos ?>"><a href="index.php?pagina=cargos_efetivo"><i class="fa fa-angle-right"></i> Cargo Efetivo</a></li>
									<li class="<?php echo @$cargos ?>"><a href="index.php?pagina=cargos_comissao"><i class="fa fa-angle-right"></i> Cargo Comissão</a></li>
									<li class="<?php echo @$cargos ?>"><a href="index.php?pagina=cargos"><i class="fa fa-angle-right"></i> Cargos</a></li>
						<!--			<li class="<?php echo @$tipos ?>"><a href="index.php?pagina=tipos"><i class="fa fa-angle-right"></i> Tipos Imóveis</a></li>-->

									<li class="<?php echo @$cidades ?>"><a href="index.php?pagina=cidades"><i class="fa fa-angle-right"></i> Cidades</a></li>
									<li class="<?php echo @$bairros ?>"><a href="index.php?pagina=bairros"><i class="fa fa-angle-right"></i> Bairros</a></li>
						<!--			<li class="<?php echo @$contas_banco ?>"><a href="index.php?pagina=contas_banco"><i class="fa fa-angle-right"></i> Contas Bancárias</a></li>-->

									<li class="<?php echo @$frequencias ?>"><a href="index.php?pagina=frequencias"><i class="fa fa-angle-right"></i> Frequências</a></li>

						<!--			<li class="<?php echo @$frequencias ?>"><a href="index.php?pagina=codificacao_comissao_salario"><i class="fa fa-angle-right"></i> Padrão Comissão</a></li>-->
...
<!--
							<li class="treeview <?php echo @$menu_imoveis ?>">
								<a href="#">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$imoveis ?>"><a href="index.php?pagina=imoveis"><i class="fa fa-angle-right"></i> Imóveis Cadastrados</a></li>
									<li class="<?php echo @$imoveis_venda ?>"><a href="index.php?pagina=imoveis-venda"><i class="fa fa-angle-right"></i> Imóveis Venda</a></li>

									<li class="<?php echo @$imoveis_locacao ?>"><a href="index.php?pagina=imoveis-locacao"><i class="fa fa-angle-right"></i> Imóveis Locação</a></li>

									<li class="<?php echo @$imoveis_vendidos ?>"><a href="index.php?pagina=imoveis-vendidos"><i class="fa fa-angle-right"></i> Imóveis Vendidos</a></li>

									<li class="<?php echo @$imoveis_alugados ?>"><a href="index.php?pagina=imoveis-alugados"><i class="fa fa-angle-right"></i> Imóveis Alugados</a></li>

									<li class="<?php echo @$imoveis_inativos ?>"><a href="index.php?pagina=imoveis-inativos"><i class="fa fa-angle-right"></i> Imóveis Inativos</a></li>
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$funcionarios ?>"><a href="index.php?pagina=agentepublico"><i class="fa fa-angle-right"></i> Agente Público</a></li>

									<li class="<?php echo @$funcionarios ?>"><a href="index.php?pagina=funcionarios"><i class="fa fa-angle-right"></i> Funcionários</a></li>
<!--
									<li class="<?php echo @$vendedores ?>"><a href="index.php?pagina=vendedores"><i class="fa fa-angle-right"></i> Vendedores / Locadores</a></li>

									<li class="<?php echo @$compradores ?>"><a href="index.php?pagina=compradores"><i class="fa fa-angle-right"></i> Compradores</a></li>


									<li class="<?php echo @$locatarios ?>"><a href="index.php?pagina=locatarios"><i class="fa fa-angle-right"></i> Locatários</a></li>

									-->
									<li class="<?php echo @$usuarios ?>"><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i> Usuários</a></li>

									<li class="<?php echo @$cargos ?>"><a href="index.php?pagina=quadro_comissao"><i class="fa fa-angle-right"></i> Quadro Comissionados</a></li>

								</ul>
							</li>

							<li class="treeview <?php echo @$agenda ?>">
							...
							<li class="treeview <?php echo @$tarefas ?>">
							...
							<li class="treeview <?php echo @$menu_financeiro ?>">
								...
								<ul class="treeview-menu">								
									...
									<li class="<?php echo @$movimentacoes ?> <?php echo $esc_cor ?>"><a href="index.php?pagina=movimentacoes"><i class="fa fa-angle-right"></i> Extrato Caixa</a></li>


									<li class="<?php echo @$comissoes ?>"><a href="index.php?pagina=comissoes"><i class="fa fa-angle-right"></i> Comissões</a></li>


									<li class="<?php echo @$vendas ?> <?php echo $esc_cor ?>"><a href="index.php?pagina=vendas"><i class="fa fa-angle-right"></i> Vendas</a></li>

									<li class="<?php echo @$alugueis ?> <?php echo $esc_cor ?>"><a href="index.php?pagina=alugueis"><i class="fa fa-angle-right"></i> Aluguéis</a></li>
							...
							<li class="treeview <?php echo @$menu_rel_financeiros ?>">
								<a href="#">
								...
								<ul class="treeview-menu">						
									...
									<li class="<?php echo @$rel_movimentacoes ?>"><a href="#" data-toggle="modal" data-target="#RelFin"><i class="fa fa-angle-right"></i> Relatório Movimentações</a></li>

									<li class="<?php echo @$rel_comissoes ?>"><a href="#" data-toggle="modal" data-target="#RelCom"><i class="fa fa-angle-right"></i> Relatório Comissões</a></li>

									<li class="<?php echo @$rel_vendas ?>"><a href="#" data-toggle="modal" data-target="#RelVen"><i class="fa fa-angle-right"></i> Relatório Vendas</a></li>

									<li class="<?php echo @$rel_alugueis ?>"><a href="#" data-toggle="modal" data-target="#RelAlu"><i class="fa fa-angle-right"></i> Relatório Aluguéis</a></li>


									<li class="<?php echo @$rel_contas_pagar ?>"><a href="#" data-toggle="modal" data-target="#RelPagar"><i class="fa fa-angle-right"></i> Relatório Contas Pagar</a></li>


									<li class="<?php echo @$rel_contas_receber ?>"><a href="#" data-toggle="modal" data-target="#RelReceb"><i class="fa fa-angle-right"></i> Relatório Contas Receber</a></li>


									<li class="<?php echo @$recibos_pagamento ?>"><a href="rel/recibo_class.php" target="_blank" ><i class="fa fa-angle-right"></i> Recibo de Pagamento</a></li>
								...
								<li class="treeview <?php echo @$menu_contratos ?>">
								<a href="#">
									<i class="fa fa-file-o"></i>
								...
								<ul class="treeview-menu">						
									...
									<li class="<?php echo @$proposta_compra ?>"><a href="rel/proposta_compra_class.php" target="_blank"><i class="fa fa-angle-right"></i> Proposta Compra</a></li>

									<li class="<?php echo @$proposta_locacao ?>"><a href="rel/proposta_aluguel_class.php" target="_blank"><i class="fa fa-angle-right"></i> Proposta Locação</a></li>

									<li class="<?php echo @$laudos ?>"><a href="index.php?pagina=laudos"><i class="fa fa-angle-right"></i> Laudo Vistorias</a></li>


									<li class="<?php echo @$vendas_juridico ?>"><a href="index.php?pagina=vendas_juridico"><i class="fa fa-angle-right"></i> Vendas</a></li>

									<li class="<?php echo @$alugueis_juridico ?>"><a href="index.php?pagina=alugueis_juridico"><i class="fa fa-angle-right"></i> Aluguéis</a></li>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown <?php echo @$agenda ?>">
						...
						<div class="row">
							<div class="col-md-3">						
								<div class="form-group"> 
									...
									<input type="text" class="form-control" name="nome_banco_config" value="<?php echo $nome_banco_imob ?>" > 
								</div>						
							</div>
							<div class="col-md-2">						
								<div class="form-group"> 
									<label>Tipo Conta</label> 
									<select class="form-control" name="tipo_conta_config" id="tipo_conta_config" value="<?php echo $tipo_conta_imob ?>"> 
							...
							<div class="col-md-2">
								<div class="form-group"> 
									<label>Agência</label> 
									<input type="text" class="form-control" name="agencia_config" id="agencia_config" value="<?php echo $agencia_imob ?>"> 
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group"> 
									<label>Conta</label> 
									<input type="text" class="form-control" name="conta_config" id="conta_config" value="<?php echo $conta_imob ?>"> 
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group"> 
									...
									<input type="text" class="form-control" name="nome_beneficiario_config" id="nome_beneficiario_config" value="<?php echo $nome_beneficiario_imob ?>"> 
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-3">						
								<div class="form-group"> 
									...
									<select class="form-control" name="tipo_chave_pix_config" id="tipo_chave_pix_config" value="<?php echo $tipo_chave_pix_imob ?>"> 
							...
							<div class="col-md-3">
								<div class="form-group"> 
									...
									<input type="text" class="form-control" name="chave_pix_config" id="chave_pix_config" value="<?php echo $chave_pix_imob ?>"> 
								</div>
							</div>
							...
							<div class="col-md-3">						
								<div class="form-group"> 
									...
									<input type="text" class="form-control" name="creci_config" value="<?php echo $creci_imob ?>" > 
								</div>						
							</div>
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control" name="cnpj_config" id="cnpj_config" value="<?php echo $cnpj_imob ?>" > 
								</div>						
							</div>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group"> 
									...
									<input maxlength="5" type="text" class="form-control" name="comissao_venda_imob_config" value="<?php echo @$comissao_venda_imob ?>" placeholder="Ex: 4 ou 4.5"> 
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group"> 
									...
									<input maxlength="5" type="text" class="form-control" name="comissao_venda_corretor_config" value="<?php echo @$comissao_venda_corretor ?>" placeholder="Ex: 4 ou 4.5"> 
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group"> 
									...
									<input maxlength="5" type="text" class="form-control" name="comissao_aluguel_imob_config" value="<?php echo @$comissao_aluguel_imob ?>" placeholder="Ex: 4 ou 4.5"> 
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group"> 
									...
									<input maxlength="5" type="text" class="form-control" name="comissao_aluguel_corretor_config" value="<?php echo @$comissao_aluguel_corretor ?>" placeholder="Comissão para Primeiro Aluguél"> 
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div id="divImgAssinatura">
									<img src="../imagens/<?php echo $assinatura ?>"  width="100%" id="target-assinatura">									
								</div>
							</div>
						</div>
								...
								<div class="form-group"> 
									...
									<select class="form-control sel12" name="corretor" style="width:100%;">
										...
										if($nivel_usu == 'Gestor'){
											...
											$query = $pdo->query("SELECT * FROM usuarios where nivel = 'Administrador' or nivel = 'Gestor' order by nivel asc");
										}
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-6">						
								<div class="form-group"> 
									<label>Data Inicial</label> 
									<input type="date" class="form-control" name="dataInicial" id="dataInicialRel-Alu" value="<?php echo date('Y-m-d') ?>" required> 
								</div>						
							</div>
							<div class="col-md-6">
								<div class="form-group"> 
									<label>Data Final</label> 
									<input type="date" class="form-control" name="dataFinal" id="dataFinalRel-Alu" value="<?php echo date('Y-m-d') ?>" required> 
								</div>
							</div>
