...
//retirar quebra de texto do obs		
		...
		//RECUPERAR O TEXTO DA VISTORIA CASO EXISTA
		$query2 = $pdo->query("SELECT * FROM contrato_aluguel where imovel = '$imovel'");
		$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
		if(@count($res2) > 0){
...
echo <<<HTML
		...
		<a href="#" onclick="parcelas('{$id}', '{$titulo}')" title="Ver Parcelas"><i class="fa fa-money " style="color:green; margin-left:3px"></i></a>
			...
			<a href="#" onclick="vistoria('{$imovel}', '{$titulo}', '{$texto_vistoria}')" title="Laudo de Vistoria"><i class="fa fa-file-pdf-o " style="color:red; margin-left:3px"></i></a>
				...
				<a href="#" onclick="contrato('{$imovel}', '{$titulo}', '{$texto_contrato}')" title="Gerar Contrato"><i class="fa fa-file-archive-o " style="color:blue; margin-left:3px"></i></a>
