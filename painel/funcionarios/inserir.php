...
//inserir o funcionário na tabela de usuários	
	if(@$nome_cargo != ""){
		$query_usu = $pdo->prepare("INSERT INTO usuarios SET nome = :nome, cpf = :cpf,  email = :email, senha_crip = :senha_crip, senha = :senha, nivel = '$nome_cargo',  foto = '$foto' , id_func = '$ult_id', ativo = 'Sim'");
...
//atualizar na tabela de usuários
	if(@$nome_cargo != ""){
		$query_usu = $pdo->prepare("UPDATE usuarios SET nome = :nome, cpf = :cpf,  email = :email, nivel = '$nome_cargo',  foto = '$foto' WHERE id_func = '$id'");
